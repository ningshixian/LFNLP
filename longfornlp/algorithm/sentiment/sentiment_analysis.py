...
from longfornlp.dictionary import negative_words_loader, sentiment_expand_words_loader, sentiment_words_loader
from longfornlp.gadget import SplitSentence
from longfornlp.algorithm.ner import LexiconNER
...
if __name__ == '__main__':
    ...
    s = '14岁女孩坠亡生前疑遭强奸致孕'
    print(gs.get_sentence_sentiment(s))
